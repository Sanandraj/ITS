                        ...
                        executorService.submit(new Callable() {
                            ...
                            Object call() throws Exception {
                                ...
                                persistenceTemplate.invoke(new CarinaPersistenceCallback() {
                                    ...
                                    public static Logger LOGGER1 = Logger.getLogger(ITSUpdateServiceOrderInJob.class)
                                    ...
                                    protected void doInTransaction() {
                                        ...
                                        if (cueList != null && !cueList.isEmpty()) {
                                            ...
                                            LOGGER1.warn("finalInvNbr"+finalInvNbr)
                                            LOGGER1.warn("Last Draft Inv Nbr"+lastInvoiceDraftNbr)
                                            // LOGGER.warn("finalInvNbr"+cue?.getStatus())
                                            if(cueStatus){
