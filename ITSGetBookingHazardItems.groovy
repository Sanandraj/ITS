...
class ITSGetBookingHazardItems  extends AbstractSimpleRequest{
    ...
    String execute(UserContext userContext, Map map) {
        ...
        MessageCollector collector = handler.executeInTransaction(userContext, FrameworkExtensionTypes.TRANSACTED_BUSINESS_FUNCTION, "ITSGetBookingHazardItemsWSCallBack", input, outPut)
