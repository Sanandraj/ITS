...
class ITSBillOfLadingMigratorJob_3 extends AbstractGroovyJobCodeExtension {
    ...
    List<Serializable> getMessagesToProcess() {
        ...
        domainQuery.addDqPredicate(PredicateFactory.gt(ArgoIntegrationField.ISM_SEQ_NBR, 74500))
