...
class ITSBillOfLadingMigratorJob extends AbstractGroovyJobCodeExtension {
    ...
    List<Serializable> getMessagesToProcess() {
        ...
        domainQuery.addDqPredicate(PredicateFactory.le(ArgoIntegrationField.ISM_SEQ_NBR, 40000))
