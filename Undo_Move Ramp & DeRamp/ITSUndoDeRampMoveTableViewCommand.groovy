 ...
 *  Load Code Extension to N4:
 ...
 Code Extension Name:  ITSUndoDeRampMoveTableViewCommand
...
class ITSUndoDeRampMoveTableViewCommand extends AbstractTableViewCommand {
    private static Logger LOGGER = Logger.getLogger(ITSUndoDeRampMoveTableViewCommand.class);
            ...
            OptionDialog.showMessage("Are you sure you want to undo the selected moves?", "Undo Move", ButtonTypes.YES_NO, MessageType.QUESTION_MESSAGE, new AbstractCarinaOptionCommand() {
                ...
                protected void safeExecute(ButtonType inOption) {
                    if (ButtonType.YES.equals(inOption)) {
                        ...
                        if (successCount > 0) {
                            OptionDialog.showMessage("Reverted UNIT_DERAMP event move successfully", "Undo Move", ButtonTypes.OK, "informationMessage", null);
                        } else {
                            OptionDialog.showMessage("Unable to revert UNIT_DERAMP move\n" + errorMsg, "Undo Move", ButtonTypes.OK, "informationMessage", null);
                        }
                    }
                }
            });
