            ...
            protected void doInTransaction() {
                if (inGkeys != null && inGkeys.size() > 0) {
                    ...
                    for (Serializable gkey : inGkeys) {
                        VesselVisitDetails vesselVisitDetails = VesselVisitDetails.hydrate(gkey)
                        ...
                        if (eFieldChange_cargo != null) {
                            ...
                            if (vesselVisitDetails.getVvFlexDate02() == null && cargoCut != null && eFieldChange_Edi == null) {
                                LOGGER.debug("ITSVesselVisitFormSubmission cargoCut is full and haz is mty ::::")
                                isValid = true;
                            } else {
                                LOGGER.debug("ITSVesselVisitFormSubmission cargoCut is mty and haz is mty ::::")
                                isValid = false;
                            }
                        }
                    }
